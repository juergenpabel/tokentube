...
typedef enum {
	...
	TT_EVENT__USER_CREATED = 10,
	TT_EVENT__USER_MODIFIED = 11,
	TT_EVENT__USER_DELETED = 12,
	TT_EVENT__OTP_CREATED = 20,
	TT_EVENT__OTP_MODIFIED = 21,
	TT_EVENT__OTP_DELETED = 22,
	TT_EVENT__UHD_CREATED = 30,
	TT_EVENT__UHD_MODIFIED = 31,
	TT_EVENT__UHD_DELETED = 32,
	TT_EVENT__AUTH_USER_VERIFIED = 40,
	TT_EVENT__AUTH_OTP_APPLIED = 41
} tt_event_t;
