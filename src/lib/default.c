...
int default__initialize(tt_plugin_t* plugin) {
	...
	plugin->interface.api.user.key_add = default__api__user_key_add;
	plugin->interface.api.user.key_del = default__api__user_key_del;
	plugin->interface.api.user.execute_loadkey = default__api__user_execute_loadkey;
