...
int pba_otp(cfg_t* cfg, tt_library_t* library, const char* identifier, char* key, size_t* key_size) {
	...
	if( pba_plymouth_otp( message, challenge, response, sizeof(response) ) != TT_OK ) {
