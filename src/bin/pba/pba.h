...
int pba_user(cfg_t*, tt_library_t* library, const char* identifier, char* key, size_t* key_size);
int pba_otp(cfg_t*, tt_library_t* library, const char* identifier, char* key, size_t* key_size);
...
int pba_plymouth_otp(const char* message, const char* prompt, char* response, size_t response_size);
