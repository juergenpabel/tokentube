...
public class MockDaoOTP implements DaoOTP {
    ...
    private static final int FIELD_OTP_BITS   =  2;
    private static final int FIELD_OTP_ITER =  3;
    private static final int FIELD_DATE_REGISTRATION =  4;
    private static final int FIELD_DATE_LAST_USAGE   =  5;

    private static final String[] RAW_DATA = {
        "test01,00000000000000000000000000000000,64,1,2013-01-01 00:00,2013-01-01 00:00"
    };
